  ...
  namespace components {
    ...
    struct BillboardSystemImpl {
      ...
      void Initialize(AppType* app) {
        ...
        LOG(INFO) << "ndtech::components:BillboardSystemImplHoloLens::Initialize";
...
#ifdef _DEBUG
        std::string vbufferName("ndtech::components::BillboardSystemImplHoloLens::m_vertexBuffer");
...
#ifdef _DEBUG
        std::string indexBufferName("ndtech::components::BillboardSystemImplHoloLens::indexBuffer");
      ...
      template <typename AppType>
      void RenderComponent(Component& component, AppType* app) {
